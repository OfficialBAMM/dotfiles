...
// node_modules/@volar/shared/out/common.js
var require_common = __commonJS({
  "node_modules/@volar/shared/out/common.js"(exports) {
    "use strict";
...
var require_ts = __commonJS({
  "node_modules/@volar/shared/out/ts.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_path = __commonJS({
  "node_modules/@volar/shared/out/path.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_protocol = __commonJS({
  "node_modules/vscode-languageserver-protocol/lib/common/protocol.js"(exports) {
    ...
    })(DocumentSelector3 = exports.DocumentSelector || (exports.DocumentSelector = {}));
...
var require_requests = __commonJS({
  "node_modules/@volar/shared/out/requests.js"(exports) {
    ...
    (function(GetDocumentVersionRequest3) {
      GetDocumentVersionRequest3.type = new vscode.RequestType("vue/docVersion");
    })(GetDocumentVersionRequest2 = exports.GetDocumentVersionRequest || (exports.GetDocumentVersionRequest = {}));
    var ShowReferencesNotification2;
    (function(ShowReferencesNotification3) {
      ShowReferencesNotification3.type = new vscode.NotificationType("vue.findReferences");
    })(ShowReferencesNotification2 = exports.ShowReferencesNotification || (exports.ShowReferencesNotification = {}));
    ...
    (function(FindFileReferenceRequest3) {
      FindFileReferenceRequest3.type = new vscode.RequestType("vue/findFileReference");
    })(FindFileReferenceRequest2 = exports.FindFileReferenceRequest || (exports.FindFileReferenceRequest = {}));
    var InitDoneRequest;
    ...
    (function(AutoInsertRequest3) {
      AutoInsertRequest3.type = new vscode.RequestType("vue/autoInsert");
    })(AutoInsertRequest2 = exports.AutoInsertRequest || (exports.AutoInsertRequest = {}));
    var VerifyAllScriptsNotification2;
    (function(VerifyAllScriptsNotification3) {
      VerifyAllScriptsNotification3.type = new vscode.NotificationType0("volar.action.verifyAllScripts");
    })(VerifyAllScriptsNotification2 = exports.VerifyAllScriptsNotification || (exports.VerifyAllScriptsNotification = {}));
...
var require_types = __commonJS({
  "node_modules/@volar/shared/out/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});
...
var require_uriMap = __commonJS({
  "node_modules/@volar/shared/out/uriMap.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@volar/shared/out/browser.js
var require_browser = __commonJS({
  "node_modules/@volar/shared/out/browser.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    __exportStar(require_uriMap(), exports);
    __exportStar(require_browser(), exports);
  }
});

// node_modules/@volar/shared/out/ts_node.js
var require_ts_node = __commonJS({
  "node_modules/@volar/shared/out/ts_node.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var fs5 = require("fs");
    var path5 = require_upath();
    function getWorkspaceTypescriptPath2(tsdk, workspaceFolderFsPaths) {
      if (path5.isAbsolute(tsdk)) {
        const tsPath = findTypescriptModulePathInLib2(tsdk);
        if (tsPath) {
          return tsPath;
        }
      } else {
        for (const folder of workspaceFolderFsPaths) {
          const tsPath = findTypescriptModulePathInLib2(path5.join(folder, tsdk));
          if (tsPath) {
            return tsPath;
          }
        }
    ...
    exports.getWorkspaceTypescriptPath = getWorkspaceTypescriptPath2;
    function getWorkspaceTypescriptLocalizedPath(tsdk, lang, workspaceFolderFsPaths) {
      if (path5.isAbsolute(tsdk)) {
        ...
        for (const folder of workspaceFolderFsPaths) {
          const tsPath = findTypescriptLocalizedPathInLib(path5.join(folder, tsdk), lang);
          if (tsPath) {
            return tsPath;
          }
        }
    ...
    function findTypescriptModulePathInLib2(lib) {
      const tsserverlibrary = path5.join(lib, "tsserverlibrary.js");
      const typescript = path5.join(lib, "typescript.js");
      const tsserver = path5.join(lib, "tsserver.js");
      if (fs5.existsSync(tsserverlibrary)) {
        return tsserverlibrary;
      }
      if (fs5.existsSync(typescript)) {
        return typescript;
      }
      if (fs5.existsSync(tsserver)) {
        return tsserver;
      }
    }
    exports.findTypescriptModulePathInLib = findTypescriptModulePathInLib2;
    function findTypescriptLocalizedPathInLib(lib, lang) {
      const localized = path5.join(lib, lang, "diagnosticMessages.generated.json");
      if (fs5.existsSync(localized)) {
        return localized;
      }
    }
    exports.findTypescriptLocalizedPathInLib = findTypescriptLocalizedPathInLib;
    function getVscodeTypescriptPath(appRoot) {
      return path5.join(appRoot, "extensions", "node_modules", "typescript", "lib", "typescript.js");
    }
    exports.getVscodeTypescriptPath = getVscodeTypescriptPath;
    function getVscodeTypescriptLocalizedPath(appRoot, lang) {
      const tsPath = path5.join(appRoot, "extensions", "node_modules", "typescript", "lib", lang, "diagnosticMessages.generated.json");
      if (fs5.existsSync(tsPath)) {
        return tsPath;
      }
    }
    ...
    function getTypeScriptVersion(serverPath) {
      ...
      const p = serverPath.split(path5.sep);
      if (p.length <= 2) {
        return void 0;
      }
      const p2 = p.slice(0, -2);
      const modulePath = p2.join(path5.sep);
      let fileName = path5.join(modulePath, "package.json");
      if (!fs5.existsSync(fileName)) {
        if (path5.basename(modulePath) === "built") {
          fileName = path5.join(modulePath, "..", "package.json");
        }
      }
      if (!fs5.existsSync(fileName)) {
        return void 0;
      }
      const contents = fs5.readFileSync(fileName).toString();
      let desc = null;
      try {
...
var require_http = __commonJS({
  "node_modules/@volar/shared/out/http.js"(exports) {
    "use strict";
...
// node_modules/@volar/shared/out/node.js
var require_node2 = __commonJS({
  "node_modules/@volar/shared/out/node.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_browser(), exports);
    __exportStar(require_ts_node(), exports);
...
// src/common.ts
var shared2 = __toESM(require_node2());
...
function doctorCommand(context) {
  return async () => {
    ...
    const serverJSON = import_path.default.join(context.extensionPath, "node_modules", "@volar", "vue-language-server", "package.json");
    ...
    if (import_coc.workspace.workspaceFolders) {
      for (const folder of import_coc.workspace.workspaceFolders) {
        const pnpmPackagesDirNames = getDirectoryItemNames(import_path.default.join(import_coc.Uri.parse(folder.uri).fsPath, "node_modules", ".pnpm"));
        const vuePackageJsonPath = import_path.default.join(import_coc.Uri.parse(folder.uri).fsPath, "node_modules", "vue", "package.json");
        const vueRuntimeDomPackageJsonPath = import_path.default.join(import_coc.Uri.parse(folder.uri).fsPath, "node_modules", "@vue", "runtime-dom", "package.json");
        const vueTscVersionPackageJsonPath = import_path.default.join(import_coc.Uri.parse(folder.uri).fsPath, "node_modules", "vue-tsc", "package.json");
    ...
    let tsVersion;
    const tsServerPath = context.workspaceState.get("coc-volar-ts-server-path");
    if (tsServerPath) {
      const typescriptPackageJsonPath = import_path.default.join(import_path.default.resolve(import_path.default.dirname(tsServerPath), ".."), "package.json");
    ...
    const doctorData = {
      ...
      tsVersion,
      tsServerPath,
      settings: import_coc.workspace.getConfiguration("volar")
    };
...
function initializeTakeOverModeCommand() {
  return async () => {
    ...
    const config = import_coc2.workspace.getConfiguration("volar");
...
async function register3(context) {
  if (import_coc3.workspace.getConfiguration("volar").get("scaffoldSnippets.enable")) {
    context.subscriptions.push(import_coc3.languages.registerCompletionItemProvider("volar", "volar", ["vue"], new scaffoldSnippetsCompletionProvider(context)));
  }
}
...
async function register4(context, languageClient) {
  ...
  updateStatusBar();
  import_coc4.events.on("BufEnter", async () => {
    updateStatusBar();
...
var shared = __toESM(require_node2());
...
var FindFileReferenceRequestType = new coc.RequestType(shared.FindFileReferenceRequest.type.method);
var AutoInsertRequestType = new coc.RequestType(shared.AutoInsertRequest.type.method);
var VerifyAllScriptsNotificationType = new coc.NotificationType0(shared.VerifyAllScriptsNotification.type.method);

// src/features/autoInsertion.ts
async function register5(context, htmlClient2, tsClient) {
  await Promise.all([htmlClient2.onReady(), tsClient.onReady()]);
  ...
  import_coc5.events.on("BufEnter", async (bn) => {
    bufnr = bn;
    if (timeout)
  ...
  async function onDidChangeTextDocument(document, changes) {
    ...
    doAutoInsert(document, lastChange, async (document2, position, lastChange2) => {
      ...
      const result = (_a = await htmlClient2.sendRequest(AutoInsertRequestType.method, params)) != null ? _a : await tsClient.sendRequest(AutoInsertRequestType.method, params);
...
async function activate(context, languageClient) {
  ...
  languageClient.onRequest(GetDocumentVersionRequestType, (handler) => {
    const doc = import_coc6.workspace.textDocuments.find((doc2) => doc2.uri.toString() === handler.uri);
...
async function register6(cmd, client) {
  import_coc7.commands.registerCommand(cmd, async (uri) => {
    await import_coc7.window.withProgress({
      ...
      await import_coc7.commands.executeCommand("editor.action.showReferences", uri, import_coc7.Position.create(0, 0), response.map((ref) => import_coc7.Location.create(ref.uri, import_coc7.Range.create(import_coc7.Position.create(ref.range.start.line, ref.range.end.line), import_coc7.Position.create(ref.range.end.line, ref.range.end.character)))));
    });
  });
}
...
async function register7(context, languageClient) {
  await languageClient.onReady();
  ...
  context.subscriptions.push(import_coc8.languages.registerInlayHintsProvider(documentSelector, inlayHintsProvider));
  context.subscriptions.push(import_coc8.commands.registerCommand("volar.toggleInlayHints", async () => {
    await inlayHintsProvider.toggle();
  }));
}
var VolarInlayHintsProvider = class {
  constructor(context, client) {
    this._onDidChangeInlayHints = new import_coc8.Emitter();
    this.onDidChangeInlayHints = this._onDidChangeInlayHints.event;
    this.context = context;
    this.client = client;
    this.inlayHintsEnabled = !!import_coc8.workspace.getConfiguration("volar").get("inlayHints.enable");
  }
  async provideInlayHints(document, range) {
    ...
    response.forEach((r) => {
      ...
      const hint = {
        label: r.label,
        position: r.position,
        kind: (_a = r.kind) != null ? _a : r.kind,
        paddingLeft: r.paddingLeft ? r.paddingLeft : void 0,
        paddingRight: r.paddingRight ? r.paddingRight : void 0,
        textEdits: r.textEdits ? r.textEdits : void 0,
        tooltip: r.tooltip ? r.tooltip : void 0,
        data: r.data ? r.data : void 0
      };
...
async function activate2(context, languageClient) {
  ...
  languageClient.onNotification(ShowReferencesNotificationType, (handler) => {
    ...
    import_coc9.commands.executeCommand("editor.action.showReferences", import_coc9.Uri.parse(uri), import_coc9.Position.create(pos.line, pos.character), refs.map((ref) => import_coc9.Location.create(ref.uri, import_coc9.Range.create(ref.range.start.line, ref.range.start.character, ref.range.end.line, ref.range.end.character))));
  });
}
...
function getCurrentTsPaths(context) {
  ...
  const tsLocaleJsonPath = import_path3.default.join(context.extensionPath, "node_modules", "typescript", "lib", tsLocalizedLang, "diagnosticMessages.generated.json");
  const localizedPath = import_fs3.default.existsSync(tsLocaleJsonPath) ? tsLocaleJsonPath : void 0;
  const builtinTsPaths = {
    serverPath: import_path3.default.join(context.extensionPath, "node_modules", "typescript", "lib", "tsserverlibrary.js"),
    localizedPath
  };
...
function getWorkspaceTsPaths(useDefault = false) {
  ...
  if (tsdk) {
    const tsPath = getWorkspaceTypescriptPath(tsdk, import_coc10.workspace.workspaceFolders.map((folder) => import_coc10.Uri.parse(folder.uri).fsPath));
    if (tsPath) {
      const tsLocalizedLang = getConfigDiagnosticsTsLocale();
      const tsLocaleJsonPath = import_path3.default.join(import_path3.default.dirname(tsPath), tsLocalizedLang, "diagnosticMessages.generated.json");
      const localizedPath = import_fs3.default.existsSync(tsLocaleJsonPath) ? tsLocaleJsonPath : void 0;
      return {
        serverPath: tsPath,
        localizedPath
...
function findTypescriptModulePathInLib(lib) {
  const tsserverlibrary = import_path3.default.join(lib, "tsserverlibrary.js");
  const typescript = import_path3.default.join(lib, "typescript.js");
  const tsserver = import_path3.default.join(lib, "tsserver.js");
  if (import_fs3.default.existsSync(tsserverlibrary)) {
    return tsserverlibrary;
  }
  if (import_fs3.default.existsSync(typescript)) {
    return typescript;
  }
  if (import_fs3.default.existsSync(tsserver)) {
    return tsserver;
  }
}
function getConfigUseWorkspaceTsdk() {
  return import_coc10.workspace.getConfiguration("volar").get("useWorkspaceTsdk", false);
}
function getConfigDiagnosticsTsLocale() {
  return import_coc10.workspace.getConfiguration("volar").get("diagnostics.tsLocale", "en");
}
function getConfigCocTsserverTsdk() {
  return import_coc10.workspace.getConfiguration("tsserver").get("tsdk");
}

// src/features/verifyAll.ts
var import_coc11 = require("coc.nvim");
async function register8(context, languageClient) {
  await languageClient.onReady();
  context.subscriptions.push(import_coc11.commands.registerCommand("volar.action.verifyAllScripts", () => {
...
var activated;
async function activate3(context, createLc) {
  register2(context);
  if (!activated) {
    const { document } = await import_coc12.workspace.getCurrentState();
    if (document.languageId === "vue") {
      doActivate(context, createLc);
      activated = true;
    }
    if (!activated && document.languageId === "markdown") {
      if (import_coc12.workspace.getConfiguration("volar").get("vitePressSupport.enable", false)) {
        doActivate(context, createLc);
        activated = true;
      }
    }
    if (!activated && document.languageId === "html") {
      if (import_coc12.workspace.getConfiguration("volar").get("petiteVueSupport.enable", false)) {
        doActivate(context, createLc);
        activated = true;
      }
    }
    if (!activated && ["javascript", "typescript", "javascriptreact", "typescriptreact"].includes(document.languageId)) {
  ...
  import_coc12.workspace.onDidOpenTextDocument(async () => {
    if (activated)
      return;
    const { document } = await import_coc12.workspace.getCurrentState();
    if (document.languageId === "vue") {
...
async function doActivate(context, createLc) {
  ...
  const takeOverMode = takeOverModeEnabled();
  const isVitePressSupport = import_coc12.workspace.getConfiguration("volar").get("vitePressSupport.enable", false);
  const isPetiteVueSupport = import_coc12.workspace.getConfiguration("volar").get("petiteVueSupport.enable", false);
  ...
  apiClient = createLc("volar-language-features", "Volar - Language Features Server", languageFeaturesDocumentSelector, getInitializationOptions(context, "main-language-features", _useSecondServer), 6009);
  docClient = _useSecondServer ? createLc("volar-language-features-2", "Volar - Second Language Features Server", languageFeaturesDocumentSelector, getInitializationOptions(context, "second-language-features", _useSecondServer), 6010) : void 0;
  htmlClient = createLc("volar-document-features", "Volar - Document Features Server", documentFeaturesDocumentSelector, getInitializationOptions(context, "document-features", _useSecondServer), 6011);
  const clients = [apiClient, docClient, htmlClient].filter(shared2.notEmpty);
  registerRestartRequest();
  registerClientRequests();
  register8(context, docClient != null ? docClient : apiClient);
  register7(context, docClient != null ? docClient : apiClient);
  register6("volar.vue.findAllFileReferences", docClient != null ? docClient : apiClient);
  register(context);
  register3(context);
  register4(context, docClient != null ? docClient : apiClient);
  if (import_coc12.workspace.getConfiguration("volar").get("autoCreateQuotes") || import_coc12.workspace.getConfiguration("volar").get("autoClosingTags") || import_coc12.workspace.getConfiguration("volar").get("autoCompleteRefs")) {
    register5(context, htmlClient, apiClient);
  }
  async function registerRestartRequest() {
    await Promise.all(clients.map((client) => client.onReady()));
    context.subscriptions.push(import_coc12.commands.registerCommand("volar.action.restartServer", async () => {
...
function getInitializationOptions(context, mode, useSecondServer2) {
  ...
  const initializationOptions = {
    ...
    languageFeatures: mode === "main-language-features" || mode === "second-language-features" ? {
      ...
      ...mode === "second-language-features" || mode === "main-language-features" && !useSecondServer2 ? {
...
function deactivate() {
  return Promise.all([apiClient == null ? void 0 : apiClient.stop(), docClient == null ? void 0 : docClient.stop(), htmlClient == null ? void 0 : htmlClient.stop()].filter(shared2.notEmpty));
}
function takeOverModeEnabled() {
  return !!import_coc12.workspace.getConfiguration("volar").get("takeOverMode.enabled");
}
function useSecondServer() {
  return !!import_coc12.workspace.getConfiguration("volar").get("vueserver.useSecondServer");
}
function getConfigTagNameCase() {
  const tagNameCase = import_coc12.workspace.getConfiguration("volar").get("completion.tagNameCase");
  switch (tagNameCase) {
    case "both":
      return "both";
    case "kebab":
...
function getConfigAttrNameCase() {
  const tagNameCase = import_coc12.workspace.getConfiguration("volar").get("completion.attrNameCase");
  switch (tagNameCase) {
    case "kebab":
      return "kebabCase";
    case "camel":
...
function getConfigDiagnostics() {
  const isDiagnosticsEnable = import_coc12.workspace.getConfiguration("volar").get("diagnostics.enable", true);
...
function getConfigDocumentFormatting() {
  const isFormattingEnable = import_coc12.workspace.getConfiguration("volar").get("formatting.enable", true);
...
function initializeWorkspaceState(context) {
  context.workspaceState.update("coc-volar-ts-server-path", void 0);
}
...
async function activate4(context) {
  if (!getConfigVolarEnable())
    return;
  return activate3(context, (id, name, documentSelector, initOptions, port) => {
    const devVolarServerPath = import_coc13.workspace.expand(getConfigDevServerPath());
    if (devVolarServerPath && fs4.existsSync(devVolarServerPath)) {
      serverModule = devVolarServerPath;
    } else {
      serverModule = context.asAbsolutePath(path4.join("node_modules", "@volar", "vue-language-server", "bin", "vue-language-server.js"));
    }
    const debugOptions = { execArgv: ["--nolazy", "--inspect=" + port] };
    const serverOptions = {
      run: { module: serverModule, transport: import_coc13.TransportKind.ipc },
      debug: {
        module: serverModule,
        transport: import_coc13.TransportKind.ipc,
    ...
    const globPatterns = ["**/*.vue", "**/*.js", "**/*.jsx", "**/*.ts", "**/*.tsx", "**/*.json"];
    if (import_coc13.workspace.getConfiguration("volar").get("vitePressSupport.enable", false)) {
      globPatterns.push("**/*.md");
    }
    if (import_coc13.workspace.getConfiguration("volar").get("volar.petiteVueSupport.enable", false)) {
    ...
    const clientOptions = {
      ...
      middleware: {
        provideCodeActions: getConfigMiddlewareProvideCodeActionsEnable() ? id === "volar-language-features" ? handleProvideCodeActions : void 0 : void 0
      },
      synchronize: {
        fileEvents: import_coc13.workspace.createFileSystemWatcher(watcherGlobPattern)
      }
    };
    const client = new import_coc13.LanguageClient(id, name, serverOptions, clientOptions);
...
function getConfigVolarEnable() {
  return import_coc13.workspace.getConfiguration("volar").get("enable", true);
}
function getConfigProgressOnInitialization() {
  return import_coc13.workspace.getConfiguration("volar").get("progressOnInitialization.enable", true);
}
function getConfigDevServerPath() {
  return import_coc13.workspace.getConfiguration("volar").get("dev.serverPath", "");
}
function getConfigServerMaxOldSpaceSize() {
  return import_coc13.workspace.getConfiguration("volar").get("vueserver.maxOldSpaceSize");
}
function getConfigMiddlewareProvideCodeActionsEnable() {
  return import_coc13.workspace.getConfiguration("volar").get("middleware.provideCodeActions.enable", true);
}
