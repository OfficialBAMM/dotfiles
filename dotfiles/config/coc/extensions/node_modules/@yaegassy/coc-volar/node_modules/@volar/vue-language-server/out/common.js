...
function createLanguageServer(connection, runtimeEnv, languageConfigs = {
    ...
    connection.onInitialize((params) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (options.documentFeatures) {
            const documentService = languageConfigs.getDocumentService({ typescript: ts }, configHost, runtimeEnv.fileSystemProvide, loadCustomPlugins(folders[0]));
        ...
        if (options.languageFeatures) {
            ...
            const projects = (0, projects_1.createProjects)(runtimeEnv, languageConfigs, folders, ts, tsLocalized, options, documents, connection, configHost, () => (0, inferredCompilerOptions_1.getInferredCompilerOptions)(ts, configuration));
            (yield Promise.resolve().then(() => require('./features/customFeatures'))).register(connection, documents, projects);
            (yield Promise.resolve().then(() => require('./features/languageFeatures'))).register(ts, connection, documents, projects, options.languageFeatures, params, languageConfigs);
