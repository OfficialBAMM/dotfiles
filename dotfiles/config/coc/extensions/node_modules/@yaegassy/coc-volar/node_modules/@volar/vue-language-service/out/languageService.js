...
function createLanguageService({ typescript: ts }, vueLsHost, fileSystemProvider, schemaRequestService, configurationHost, customPlugins, getNameCases, createLanguageServiceContext = () => vueTs.createLanguageServiceContext(ts, vueLsHost)) {
    ...
    const vueDocuments = (0, vueDocuments_1.parseVueDocuments)(vueLsCtx, tsLs);
