...
function useVueTemplateLanguagePlugin(options) {
    ...
    return Object.assign(Object.assign({}, options.templateLanguagePlugin), { complete: {
            ...
            const vueDocument = options.vueDocuments.fromEmbeddedDocument(document);
            if (vueDocument) {
                options.templateLanguagePlugin.htmlLs.setDataProviders(useDefaultDataProvider(vueDocument.uri), options.templateLanguagePlugin.getHtmlDataProviders());
            }
            ...
            function getTypeScriptInsert() {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const [formatOptions, preferences] = yield Promise.all([
                        (_c = (_b = (_a = options.tsSettings).getFormatOptions) === null || _b === void 0 ? void 0 : _b.call(_a, embeddedScriptUri)) !== null && _c !== void 0 ? _c : {},
                        (_f = (_e = (_d = options.tsSettings).getPreferences) === null || _e === void 0 ? void 0 : _e.call(_d, embeddedScriptUri)) !== null && _f !== void 0 ? _f : {},
                    ]);
    ...
    function provideHtmlData(vueDocument) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            options.templateLanguagePlugin.htmlLs.setDataProviders(useDefaultDataProvider(vueDocument.uri), [
    ...
    function useDefaultDataProvider(uri) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!cache) {
                ...
                if (file && document) {
                    ...
                    try {
                        const offset = file.content.indexOf(vue_typescript_1.SearchTexts.GlobalAttrs);
